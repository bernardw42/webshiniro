...
const Card: React.FC<CardProps> = ({ title, image, className}) => {
  return (
    <div className={`flex flex-col justify-center items-center bg-white gap-y-[20px] max-w-[350px] min-h-[450px] max-h-[450px] rounded-lg drop-shadow-2xl px-8 py-14 ${className}`}>
